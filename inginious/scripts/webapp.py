...
def main():
    ...
    parser.add_argument(
        ...
        default=os.environ.get("INGINIOUS_WEBAPP_HOST", "localhost"),
    )
    parser.add_argument(
        "--port",
        help="Port to listen to. Default is 8080.",
        type=int,
        default=os.environ.get("INGINIOUS_WEBAPP_PORT", "8080"),
    )
    ...
    application = SharedDataMiddleware(
        application, [("/static/", os.path.join(root_path, "frontend", "static"))]
    )
