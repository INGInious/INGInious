...
class DisplayableCodeProblem(CodeProblem, DisplayableProblem):
    ...
    def __init__(self, problemid, content, translations, taskfs):
        super(DisplayableCodeProblem, self).__init__(
    ...
    def show_editbox(cls, key, language):
        return render_template(
            "course_admin/subproblems/code.html", key=key, multiline=True
        )
...
class DisplayableCodeSingleLineProblem(CodeSingleLineProblem, DisplayableProblem):
    ...
    def __init__(self, problemid, content, translations, taskfs):
        super(DisplayableCodeSingleLineProblem, self).__init__(
            problemid, content, translations, taskfs
        )
    ...
    def show_editbox(cls, key, language):
        return render_template(
            "course_admin/subproblems/code.html", key=key, multiline=False
        )
...
class DisplayableFileProblem(FileProblem, DisplayableProblem):
    ...
    def __init__(self, problemid, content, translations, taskfs):
        super(DisplayableFileProblem, self).__init__(
            problemid, content, translations, taskfs
        )
    ...
    def adapt_input_for_backend(self, input_data):
        try:
            input_data[self.get_id()] = {
                "filename": input_data[self.get_id()].filename,
...
class DisplayableMultipleChoiceProblem(MultipleChoiceProblem, DisplayableProblem):
    ...
    def __init__(self, problemid, content, translations, taskfs):
        super(DisplayableMultipleChoiceProblem, self).__init__(
            problemid, content, translations, taskfs
        )
    ...
    def _filter_choices(self, pre_shuffled_choices: list[dict]):
        ...
        invalid_choices = [
            entry for entry in pre_shuffled_choices if not entry["valid"]
        ]
    ...
    def show_editbox_templates(cls, key, language):
        return render_template(
            "course_admin/subproblems/multiple_choice_templates.html", key=key
        )
...
class DisplayableMatchProblem(MatchProblem, DisplayableProblem):
    ...
    def __init__(self, problemid, content, translations, taskfs):
        super(DisplayableMatchProblem, self).__init__(
            problemid, content, translations, taskfs
        )
