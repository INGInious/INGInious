...
class CourseRegisterPage(INGIniousAuthPage):
    ...
    def basic_checks(self, courseid):
        ...
        if self.user_manager.course_is_user_registered(
            course, username
        ) or not course.is_registration_possible(user_info):
            return course, None
    ...
    def POST_AUTH(self, courseid):
        ...
        success = self.user_manager.course_register_user(
            course, username, user_input.get("register_password", None)
        )
